...
`research/README.md`; danh mục tham khảo đã chèn vào `PROJECT_PLAN.md`.
...
- Pipeline tái lập được: `traffic/maxspeed/baseline/run.sh` (osmium + python/pyproj).
...
*Phụ lục: số liệu máy đọc tại `traffic/maxspeed/baseline/maxspeed_coverage_result.json`;
