#!/usr/bin/env python3
"""Publish the wiki + plan + geocode README to Confluence Cloud.
...
PAGES = [
    ("wiki",    "wiki/01-bo-wiki-luat-internal.md",    "OSM Luật Internal — Wiki",                 None,   "NR"),
    ("matrix",  "wiki/02-bang-quyet-dinh-theo-luat.md","Bảng Quyết Định theo Luật",                "wiki", "NR"),
    ("plan",    "traffic/maxspeed/plans/maxspeed-name-edit-plan.md",    "Maxspeed/Name Edit — Kế hoạch triển khai", "wiki", "NR"),
    ("geocode", "admin-poi/geocode/README.md",                                  "VN Admin Geocode — Dataset",               None,   "GSPA"),
]
